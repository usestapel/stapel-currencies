# Contributing to stapel-currencies
...
```bash
git clone https://github.com/usestapel/stapel-currencies.git && cd stapel-currencies
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_CURRENCIES` dict; see `conf.py`) — with a dotted-path
